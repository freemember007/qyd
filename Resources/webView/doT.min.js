(function() {
    ...
    function p(a, b, c) {
        return ("string" == typeof b ? b : b.toString()).replace(a.define || i, function(l, e, f, g) {
            0 === e.indexOf("def.") && (e = e.substring(4));
            if (!(e in c)) if (":" === f) {
            ...
            a.useParams && (e = e.replace(a.useParams, function(g, n, h, d) {
                if (c[h] && c[h].arg && d) {
                    g = (h + ":" + d).replace(/'|\\/g, "_");
                    c.__exp = c.__exp || {};
    ...
    if ("undefined" != typeof module && module.exports) module.exports = j; else if ("function" == typeof define && define.amd) define(function() {
        return j;
    }); else {
        q = function() {
    ...
    j.template = function(a, b, c) {
        ...
        var e, g, l = b.append ? r.append : r.split, f = 0;
        ...
        e && b.selfcontained && (a = "String.prototype.encodeHTML=(" + o.toString() + "());" + a);
        try {
            return new Function(b.varname, a);
        } catch (n) {
            "undefined" != typeof console && console.log("Could not create a template function: " + a);
            throw n;
        }
    };
